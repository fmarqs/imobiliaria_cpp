...
void Imobiliaria::remover_imov()
{
    ...
    vector<Apartamento>::iterator it2;
    it2 =  apt.begin();

    vector<Terreno>::iterator it3;
    it3 = ground.begin();
    ...
    if(o==1){
        ...
        cout << "Deseja remover esse apartamento?" << endl;
        cout << "[1] SIM | [QUALQUER NUMERO] NÃO" << endl;
        cin >> op;
        if(op==1){
            apt.erase(it2);
        ...
        cout << "Deseja remover esse terreno?" << endl;
        cout << "[1] SIM | [QUALQUER NUMERO] NÃO" << endl;
        cin >> op;
        cout << i;
        if(op==1){
